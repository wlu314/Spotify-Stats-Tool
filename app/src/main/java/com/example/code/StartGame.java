...
public class StartGame extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        techList.add("Ariana Grande");
        techList.add("Arijit Singh");
        techList.add("Bad Bunny");
        techList.add("Billie Eilish");
        techList.add("Drake");
        techList.add("Ed Sheeran");
        techList.add("Eminem");
        techList.add("Justin Bieber");
        techList.add("Taylor Swift");
        techList.add("The Weeknd");

        map.put(techList.get(0), R.drawable.ariana_grande);
        map.put(techList.get(1), R.drawable.arijit_singh);
        map.put(techList.get(2), R.drawable.bad_bunny);
        map.put(techList.get(3), R.drawable.billie_eilish);
        map.put(techList.get(4), R.drawable.drake);
        map.put(techList.get(5), R.drawable.ed_sheeran);
        map.put(techList.get(6), R.drawable.eminem);
        map.put(techList.get(7), R.drawable.justin_bieber);
        map.put(techList.get(8), R.drawable.taylor_swift);
        map.put(techList.get(9), R.drawable.the_weeknd);
